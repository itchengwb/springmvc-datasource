    ...
    <div class="oauth_wrap">
        <div class="oauth_header clearfix">
            ...
            <p class="login_account">
                <a href="###" class="special_login_link" node-type="loginswitch">二维码登录</a><span
                    class="vline vline_login">|</span><a class="sign_up_link"
                                                         href="http://weibo.com/signup/signup.php?from=zw&appsrc=5lx2Db&backurl=https%3A%2F%2Fapi.weibo.com%2F2%2Foauth2%2Fauthorize%3Fclient_id%3D3317874941%26response_type%3Dcode%26display%3Ddefault%26redirect_uri%3Dhttps%253A%252F%252Fwww.yooli.com%252Foauthfromweibo.action%26from%3D%26with_cookie%3D"
                                                         target="_blank">注册</a>
            </p>
        </div>
        <!-- 带头像  -->
            ...
            <form name="authZForm" action="/oauth2/authorize" method="post"
                ...
                <div class="oauth_content" node-type="commonlogin">
                    <p class="oauth_main_info">
                        使用你的微博帐号访问 <a href="http://app.weibo.com/t/feed/5lx2Db"
                                      target="_blank" class="app_name">有利网Yooli.com</a> ，并同时登录微博
                    </p>
                    <!-- 登录 -->
                    <div class="oauth_login clearfix">
                        ...
                        <input type="hidden" name="action" id="action" value="login" /> <input
                            type="hidden" id="display" name="display" value="default" /> <input
                            type="hidden" name="withOfficalFlag" id="withOfficalFlag"
                            value="0" /> <input type="hidden" name="quick_auth"
                                                id="quick_auth" value="null" /> <input type="hidden"
                                                                                       name="withOfficalAccount" id="withOfficalAccount" value="" /> <input
                            type="hidden" name="scope" id="scope" value="" /> <input
                            type="hidden" name="ticket" id="ticket" value="" /> <input
                            type="hidden" name="isLoginSina" id="isLoginSina" value="" /> <input
                            type="submit" style="position: absolute; top: -9999px" /> <input
                            type="hidden" name="response_type" value="code" /> <input
                            type="hidden" name="regCallback"
                            value="https%3A%2F%2Fapi.weibo.com%2F2%2Foauth2%2Fauthorize%3Fclient_id%3D3317874941%26response_type%3Dcode%26display%3Ddefault%26redirect_uri%3Dhttps%253A%252F%252Fwww.yooli.com%252Foauthfromweibo.action%26from%3D%26with_cookie%3D" />
                        <input type="hidden" name="redirect_uri"
                               value="https://www.yooli.com/oauthfromweibo.action" /> <input
                            type="hidden" name="client_id" value="3317874941" /> <input
                            type="hidden" name="appkey62" value="5lx2Db" /> <input
                            type="hidden" name="state" value="%3Fpasswd%3Djili111jj%3B" /> <input
...
<div class="qr-cover" style="display: none;" node-type="qrcodelogin">
    <div class="qr-cover-inner">
        ...
        <div class="qr-tip">
            <div class="qr-txt">使用微博客户端扫描二维码登录“有利网Yooli.com”</div>
...
<script type="text/javascript"
        src="/oauth2/js/oauth2Web.js?version=20141113"></script>
<script type="text/javascript">	(function() {	if(self !== top) {	var img = new Image();	var src = 'https://api.weibo.com/oauth2/images/bg_layerr.png?oauth=1&page=web&refer=' + document.referrer + '&rnd=' + (+new Date());	img.src = src	img = null; //释放局部变量	}	})();</script>
</body>
</html>
